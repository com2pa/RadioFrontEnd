...
const PodcastSubcategory = () => {
  ...
  const createSubcategory = async (subcategoryData) => {
    try {
      const response = await axios.post('/api/subcategory-podscats/create', subcategoryData)
  ...
  const updateSubcategory = async (subcategoryId, subcategoryData) => {
    try {
      const response = await axios.put(`/api/subcategory-podscats/update/${subcategoryId}`, subcategoryData)
      setSubcategories(prev => prev.map(sub => 
        sub.subcategoryId === subcategoryId ? response.data : sub
      ))
      return true
    } catch (error) {
  ...
  const deleteSubcategory = async (subcategoryId) => {
    try {
      await axios.delete(`/api/subcategory-podscats/delete/${subcategoryId}`)
      ...
      <Container maxW="container.xl" py={{ base: 4, md: 6, lg: 8 }} px={{ base: 4, md: 6 }}>
        <VStack spacing={{ base: 4, md: 6, lg: 8 }} align="stretch">
              ...
              <VStack align={{ base: "start", md: "start" }} spacing={2}>
                ...
                >
                  ...
                  <Heading 
                    ...
                    color="blue.600"
                  >
                    Gestión de Subcategorías de Podcasts
                  </Heading>
                </Flex>
                <Text 
                  color={textColor}
                ...
                >
                  Crear y administrar subcategorías para podcasts
                </Text>
              </VStack>
          ...
          <AdminMenu 
            isOpen={isOpen}
            onClose={onClose}
            currentPage="/dashboard/admin/podcast-subcategory"
          />
                  ...
                  <VStack spacing={{ base: 3, md: 4 }} align="stretch">
                    ...
                    <FormControl isRequired>
                      ...
                      <Input
                        ...
                        onChange={handleInputChange}
                        placeholder="Ej: Inteligencia Artificial, Desarrollo Web, Cine"
                        size={{ base: "sm", md: "md" }}
                      />
                    </FormControl>
...
export default PodcastSubcategory
